...
curl -X POST -H 'Content-type:application/json' --data-binary '{"add-field":{"name":"about","type":"topics_'$SIM'","stored":true, "termVectors":true }}' http://localhost:8983/solr/$COLLECTION/schema
